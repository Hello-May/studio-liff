interface LIFF {
  init(config: { liffId: string }, successCallback?: () => void, errorCallback?: () => void): Promise<void>;
  getProfile(): Promise<LIFFUserProfile>;
  sendMessages(
    messages: Array<LIFFTextMessage | LIFFImageMessage | LIFFVideoMessage | LIFFAudioMessage | LIFFLocationMessage>
  ): Promise<void>;
